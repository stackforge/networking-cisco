...
~~~~~~~~~~~~~~~~~~~~
If the Nexus MD discovered that a Nexus switch was lost due to rebooting or
due to lost of network connectivity, all known configuration for this switch is
replayed.  The order of the events are performed differently than described
