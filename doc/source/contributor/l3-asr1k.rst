...
`cisco_device_manager_plugin.inject <../_static/config-samples/cisco_device_manager_plugin.inject>`_
file.

.. literalinclude:: ../_static/config-samples/cisco_device_manager_plugin.inject

A ``cisco_router_plugin.inject`` sample file
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
The sample inject file below can be viewed as a raw text
`cisco_router_plugin.inject <../_static/config-samples/cisco_router_plugin.inject>`_
file.

.. literalinclude:: ../_static/config-samples/cisco_router_plugin.inject
