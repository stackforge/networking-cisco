...
There are two configuration files used to configure features with the
Nexus Mechanism Driver.

* Neutron start-up configuration files
* 'Tripleo' which is used for Openstack on Openstack configurations.
  See `Openstack on Openstack/Tripleo Configurations for VLAN Configuration`_
  for more details.
...
#. Add the Nexus switch information to the configuration file. Multiple switches
   ...
   * intfcfg.port-channel (baremetal only).  This is an optional config
     ...
     See :doc:`reference doc </reference/ml2-nexus>` for more details on
...
also be omitted if only baremetal deployments exist. Refer to
:doc:`Nexus MD Overview and Architecture documentation </reference/ml2-nexus>`
...
Configuring Neutron with Nexus for Non-DHCP Agent Enabled Network Node Topologies
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
Openstack on Openstack/Tripleo Configurations for Non-DHCP Agent Enabled Network Node Topologies
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
The following is the Tripleo version of configuring what was described in
section `Configuring Neutron with Nexus for Non-DHCP Agent Enabled Network Node Topologies`_.
