...
For more information on provider networks refer to the `Provider Networks <https://docs.openstack.org/ocata/networking-guide/intro-os-networking.html#provider-networks>`_
