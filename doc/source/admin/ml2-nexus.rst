...
.. code-block:: ini
    ...
    #  currently False but will soon change to True to allow time to
    #  acquire a certificate from a public Certificate Authority and
    #  to configure the Nexus device with the certificate and key files.
    https_verify=True
