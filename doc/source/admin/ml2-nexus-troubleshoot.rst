...
::
    ...
    ERROR neutron.service DBDuplicateEntry: (pymysql.err.IntegrityError) 
...
in Cisco Release 5.4.0.  To eliminate this erro, upgrade to a more
recent release of networking-cisco repo.
