...
def upgrade():
    ...
    op.create_table('topology_discovery',
        sa.Column('host', sa.String(length=255), nullable=False),
        sa.Column('protocol_interface', sa.String(length=48),
                  primary_key=True, nullable=False),
        sa.Column('phy_interface', sa.String(length=48), nullable=True),
        sa.Column('created', sa.DateTime(), nullable=True),
        sa.Column('heartbeat', sa.DateTime(), nullable=True),
        sa.Column('remote_mgmt_addr', sa.String(length=32), nullable=True),
        sa.Column('remote_system_name', sa.String(length=128), nullable=True),
        sa.Column('remote_system_desc', sa.String(length=256), nullable=True),
        sa.Column('remote_port_id_mac', sa.String(length=17), nullable=True),
        sa.Column('remote_chassis_id_mac', sa.String(length=17),
                  nullable=True),
        sa.Column('remote_port', sa.String(length=48), nullable=True),
        sa.Column('remote_evb_cfgd', sa.Boolean(), nullable=True),
        sa.Column('remote_evb_mode', sa.String(length=16), nullable=True),
        sa.Column('configurations', sa.String(length=512), nullable=True),
        sa.PrimaryKeyConstraint('host'),
        sa.PrimaryKeyConstraint('protocol_interface')
    )
