...
class FwMgr(dev_mgr.DeviceMgr):
    ...
    def fw_update(self, data, fw_name=None):
        ...
        try:
            ...
            LOG.error(_LE("Exception in fw_update %s"), str(exc))
    ...
    def fw_delete(self, data, fw_name=None):
        ...
        try:
            ...
            LOG.error(_LE("Exception in fw_delete %s"), str(exc))
    ...
    def fw_rule_create(self, data, fw_name=None, cache=False):
        ...
        try:
            ...
            LOG.error(_LE("Exception in fw_rule_create %s"), str(exc))
    ...
    def fw_rule_delete(self, data, fw_name=None):
        ...
        try:
            ...
            LOG.error(_LE("Exception in fw_rule_delete %s"), str(exc))
    ...
    def fw_rule_update(self, data, fw_name=None):
        ...
        try:
            ...
            LOG.error(_LE("Exception in fw_rule_update %s"), str(exc))
    ...
    def fw_policy_delete(self, data, fw_name=None):
        ...
        try:
            ...
            LOG.error(_LE("Exception in fw_policy_delete %s"), str(exc))
    ...
    def fw_policy_create(self, data, fw_name=None, cache=False):
        ...
        try:
            ...
            LOG.error(_LE("Exception in fw_policy_create %s"), str(exc))
