...
class EventsHandler(object):
    ...
    def __init__(self, ser_name, pqueue, c_pri, d_pri):
        ...
        if self._service_name == 'keystone':
            ...
            self._service = client.Client(
                username=self._cfg.keystone.admin_user_name,
                tenant_name=self._cfg.keystone.admin_tenant_name,
                password=self._cfg.keystone.admin_password,
                auth_url=self._endpoint_url)
