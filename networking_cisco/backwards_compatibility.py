...
n_p_c = __import__('neutron.plugins.common.constants', fromlist=['plugins.common.constants'])
...
if NEUTRON_VERSION >= NEUTRON_QUEENS_VERSION:
    ...
    from neutron.callbacks import registry as cb_registry
    from neutron.plugins.ml2 import driver_api as ml2_api
