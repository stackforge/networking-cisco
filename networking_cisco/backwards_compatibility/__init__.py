...
if nv.NEUTRON_VERSION >= nv.NEUTRON_STEIN_VERSION:
    ...
    from neutron.db.resource_extend import extends
    from neutron.db.resource_extend import get_funcs  # noqa
    from neutron.db.resource_extend import has_resource_extenders  # noqa
