...
if nv.NEUTRON_VERSION >= nv.NEUTRON_STEIN_VERSION:
    from neutron_lib.db import model_query as n_db_model_query  # noqa
    from neutron_lib import exceptions as n_exc  # noqa
    from neutron_lib import rpc as n_rpc  # noqa
    from neutron_lib.tests.unit import fake_notifier  # noqa
else:
    from neutron.common import exceptions as n_exc  # noqa
    from neutron.common import rpc as n_rpc  # noqa
