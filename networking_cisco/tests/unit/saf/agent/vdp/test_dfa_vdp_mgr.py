...
class DfaVdpMgrTest(base.BaseTestCase):
    ...
    def test_vdp_uplink_proc_normal_bond_intf(self):
        ...
        self.assertEqual(True, self.dfa_vdp_mgr.process_uplink_ongoing)
        self.assertEqual(False, self.dfa_vdp_mgr.uplink_det_compl)
    ...
    def test_vdp_vm_event_list(self):
        ...
        enq.assert_called_with(constants.Q_VM_PRIO, 'some obj')
        self.assertEqual(True, self.dfa_vdp_mgr.bulk_vm_rcvd_flag)
    ...
    def test_dfa_uplink_restart_no_uplink(self):
        ...
        self.assertEqual(True, self.dfa_vdp_mgr.restart_uplink_called)
