...
class DfaVdpMgrTest(base.BaseTestCase):
    ...
    def setUp(self):
        ...
        self.config_dict['external_bridge'] = self.br_ex
        self.config_dict['root_helper'] = self.root_helper
        self.config_dict['node_list'] = 'hostabc'
        self.config_dict['node_uplink_list'] = self.uplink
