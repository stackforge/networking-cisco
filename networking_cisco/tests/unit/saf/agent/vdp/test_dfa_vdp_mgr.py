...
from networking_cisco.plugins.saf.agent.vdp import dfa_vdp_mgr
from networking_cisco.plugins.saf.agent.vdp import ovs_vdp
from networking_cisco.plugins.saf.common import constants
from networking_cisco.plugins.saf.common import dfa_sys_lib as utils
...
class DfaVdpMgrTest(base.BaseTestCase):
    ...
    def _test_dfa_mgr_init(self):
        ...
        with mock.patch('networking_cisco.plugins.saf.common.utils.'
                        'EventProcessingThread') as event_fn,\
                mock.patch('networking_cisco.plugins.saf.common.'
    ...
    def _test_process_up_uplink_event(self):
        ...
        with mock.patch('networking_cisco.plugins.saf.agent.'
