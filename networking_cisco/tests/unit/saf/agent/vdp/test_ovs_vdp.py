...
from networking_cisco.plugins.saf.agent.vdp import vdp_constants as vconstants
...
class OvsVdpTest(base.BaseTestCase):
    ...
    def _test_ovs_vdp_init(self):
        ...
        lldp_ovs_portnum = 14
        phy_port_num = 14
        with mock.patch('networking_cisco.plugins.saf.common.'
            ...
            mock.patch('neutron.agent.linux.ip_lib.'
                ...
                mock.patch('networking_cisco.plugins.saf.'
