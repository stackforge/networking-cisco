...
class TestCiscoDFAClient(base.BaseTestCase):
    ...
    def test_http_login_test(self):
        """Test login test using http. """

        self.dcnm_client._login_test('http')
        test_login_url = 'http://' + FAKE_DCNM_IP + '/rest/logon'
        test_logout_url = 'http://' + FAKE_DCNM_IP + '/rest/logout'
        self.login.assert_called_with(test_url=test_login_url)
        self.logout.assert_called_with(test_url=test_logout_url)

    def test_https_login_test(self):
        """Test login test using https. """

        self.dcnm_client._login_test('https')
