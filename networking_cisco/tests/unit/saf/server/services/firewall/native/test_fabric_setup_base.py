...
class FabricBaseTest(base.BaseTestCase):
    ...
    def setUp(self):
        ...
        with mock.patch('networking_cisco.apps.saf.db.dfa_db_models.'
                        'DfaSegmentTypeDriver'),\
    ...
    def _prepare_fw_dict(self):
        mock_fw_dict = {}
        mock_fw_dict['rules'] = {}
        mock_fw_dict['tenant_name'] = self.tenant_name
        mock_fw_dict['tenant_id'] = self.tenant_id
        mock_fw_dict['fw_id'] = self.fw_id
        mock_fw_dict['fw_name'] = self.fw_name
        mock_fw_dict['firewall_policy_id'] = self.policy_id
        mock_fw_dict['fw_type'] = self.fw_type
        mock_fw_dict['router_id'] = self.router_id
        return mock_fw_dict
    ...
    def _prepare_rtr_net_dict(self):
        rtr_nwk = self.fw_id[0:4] + fw_const.DUMMY_SERVICE_NWK + (
            self.fw_id[len(self.fw_id) - 4:])
        network_dict = {'tenant_id': self.tenant_id, 'name': rtr_nwk,
                        'segmentation_id': None, 'vlan': None,
                        'config_profile': None, 'fwd_mode': None}
        return network_dict

    def _fill_fw_net_dict(self):
        fw_net_dict = {'fw_id': self.fw_id, 'tenant_id': self.tenant_id,
    ...
    def _fill_fw_rtr_net_dict(self):
        fw_net_dict = {'router_id': self.router_id, 'name': self.fw_name,
    ...
    def _fill_fw_dcnm_net_dict(self):
        fw_net_dict = {'router_id': self.router_id,
                       'out_network_id': self.out_net_id,
                       'name': self.fw_name,
                       'router_net_id': self.rtr_net_id,
                       'tenant_id': self.tenant_id,
    ...
    def _fill_fw_db_data(self):
        fw_data = dict()
        fw_data[self.fw_id] = {
            'tenant_id': self.tenant_id, 'name': self.fw_name,
            'in_network_id': self.net_id, 'out_network_id': self.out_net_id,
            'os_status': fw_const.OS_DUMMY_RTR_CREATE_SUCCESS,
            'result': fw_const.RESULT_FW_CREATE_INIT,
            'router_id': self.router_id, 'router_net_id': self.rtr_net_id,
            'router_subnet_id': self.rtr_subnet_id}
        return fw_data

    def _test_create_in_nwk(self):
        id_list = []
        ...
        with mock.patch('networking_cisco.apps.saf.server.services.firewall.'
            ...
            mock.patch.object(self.fabric_base,
                              'add_network_db') as add_nwk_db,\
            mock.patch('networking_cisco.apps.saf.db.dfa_db_models.'
                       'DfaDBMixin.update_fw_db'),\
            mock.patch('networking_cisco.apps.saf.db.dfa_db_models.DfaDBMixin.'
                       'append_state_final_result') as app_state_final_res,\
            mock.patch('networking_cisco.apps.saf.db.dfa_db_models.DfaDBMixin.'
                       'update_fw_db_result') as upd_fw_db_res:
            FakeClass.set_return(fsb.FabricApi, 'get_in_ip_addr',
                                 [self.in_subnet, self.in_start,
                                  self.in_sec_gw, self.in_gw, self.in_end])
            ...
            parent.attach_mock(add_nwk_db, 'add_network_db')
            parent.attach_mock(upd_fw_db_res, 'update_fw_db_result')
            parent.attach_mock(app_state_final_res,
    ...
    def test_create_in_nwk(self):
        ...
        self._test_create_in_nwk()

    def _test_create_in_nwk_fail(self):
        id_list = []
        with mock.patch('networking_cisco.apps.saf.server.services.firewall.'
                        'native.fabric_setup_base.ServiceIpSegTenantMap.'
                        'get_state',
        ...
        parent.assert_has_calls(expected_calls, any_order=False)
        add_nwk_db.assert_not_called()
        upd_fw_db_res.assert_not_called()

    def test_create_in_nwk_fail(self):
        """Create IN Network Fail"""
        self._test_create_in_nwk_fail()

    def _test_create_out_nwk(self):
        id_list = []
        ...
        with mock.patch('networking_cisco.apps.saf.server.services.firewall.'
            ...
            FakeClass.set_return(fsb.FabricApi, 'get_out_ip_addr',
                                 [self.out_subnet, self.out_start,
                                  self.out_sec_gw, self.out_gw, self.out_end])
            self.fabric_base.service_segs.allocate_segmentation_id.\
    ...
    def test_create_out_nwk(self):
        ...
        self._test_create_out_nwk()

    def _test_create_out_nwk_fail(self):
        id_list = [None, None]
        with mock.patch('networking_cisco.apps.saf.server.services.firewall.'
                        'native.fabric_setup_base.ServiceIpSegTenantMap.'
                        'get_state',
    ...
    def test_create_out_nwk_fail(self):
        ...
        self._test_create_out_nwk_fail()

    def _test_create_os_dummy_rtr(self):
        id_list = []
    ...
    def test_create_os_dummy_rtr(self):
        ...
        self._test_create_os_dummy_rtr()

    def _test_create_os_dummy_rtr_fail(self):
        id_list = []
        id_list.append(self.rtr_net_id)
        id_list.append(self.rtr_subnet_id)
        rtr_net_list = set()
    ...
    def test_create_os_dummy_rtr_fail(self):
        ...
        self._test_create_os_dummy_rtr_fail()

    def _test_create_os_dummy_rtr_virt(self):
        id_list = []
        id_list.append(self.rtr_net_id)
        id_list.append(self.rtr_subnet_id)
        rtr_net_list = set()
    ...
    def test_create_os_dummy_rtr_virt(self):
        ...
        self._test_create_os_dummy_rtr_virt()

    def _test_create_dcnm_in_nwk(self):
        """
        ...
        with mock.patch('networking_cisco.apps.saf.server.services.firewall.'
            ...
            # mock records the updated fw_dict as a result of which argument
            # check fails.
            FakeClass.set_return(dbm.DfaDBMixin, 'get_all_fw_db',
                                 self._fill_fw_db_data())
        ...
        expected_calls = [mock.call.Dict2Obj(fw_dcnm_rest_net_dict),
                          ...
                          mock.call.append_state_final_result(
                              ...
                              fw_const.DCNM_IN_PART_UPDATE_STATE)]
        parent.assert_has_calls(expected_calls, any_order=False)
        create_nwk.assert_called()

    def test_create_dcnm_in_nwk(self):
        """Create IN Network Test"""
        self._test_create_dcnm_in_nwk()

    def _test_create_dcnm_in_part_update(self):
    ...
    def test_create_dcnm_in_part_update(self):
        ...
        self._test_create_dcnm_in_part_update()

    def _test_create_dcnm_out_part(self):
    ...
    def test_create_dcnm_out_part(self):
        ...
        self._test_create_dcnm_out_part()

    def _test_create_dcnm_out_nwk(self):
        """
        This function relies on the state information filled by previous
        functions. So, rather than starting fresh, we shall populate the
        FW DB. This is equivalent to restarting the enabler server and it
    ...
    def test_create_dcnm_out_nwk(self):
        """Create OUT Network Test"""
        self._test_create_dcnm_out_nwk()

    def _test_create_dcnm_out_part_update(self):
    ...
    def test_create_dcnm_out_part_update(self):
        ...
        self._test_create_dcnm_out_part_update()
    ...
    def _test_delete_nwk(self, state, direc):
        ...
        fw_db_data = self._fill_fw_db_data()
    ...
    def _test_delete_os_dummy_rtr(self):
        fw_net_dict2 = self._fill_fw_del_net_dict()
    ...
    def test_delete_os_dummy_rtr(self):
        ...
        self._test_delete_os_dummy_rtr()

    def _test_delete_os_dummy_rtr_fail(self):
        fw_net_dict2 = self._fill_fw_del_net_dict()
    ...
    def test_delete_os_dummy_rtr_fail(self):
        ...
        self._test_delete_os_dummy_rtr_fail()
    ...
    def test_clear_dcnm_in_part(self):
        ...
        self._test_clear_dcnm_in_part()

    def _test_delete_dcnm_out_part(self):
        fw_net_dict2 = self._fill_fw_del_net_dict()
    ...
    def test_clear_dcnm_out_part(self):
        ...
        self._test_clear_dcnm_out_part()
