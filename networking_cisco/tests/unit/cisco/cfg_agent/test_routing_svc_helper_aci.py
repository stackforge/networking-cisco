...
class TestBasicRoutingOperationsAci(helper.TestBasicRoutingOperations):
    ...
    def test_process_router_2_rids_1_vrf(self):
        ...
        self.assertEqual(len(self.routing_helper._router_ids_by_vrf), 1)
        self.assertEqual(len(self.routing_helper._router_ids_by_vrf[vrf]), 1)
        ...
        self.assertEqual(len(self.routing_helper._router_ids_by_vrf), 1)
        self.assertEqual(len(self.routing_helper._router_ids_by_vrf[vrf]), 2)
...
class TestNetworkRoutingOperationsAci(base.BaseTestCase):
    ...
    def test_process_router_2_rids_1_vrf_1_network(self):
        ...
        self.assertEqual(len(v_n_r_dict), 1)
        self.assertEqual(len(v_n_r_dict[vrf]), 1)
        self.assertEqual(len(v_n_r_dict[vrf][network_name]), 1)
        ...
        self.assertEqual(len(v_n_r_dict), 1)
        self.assertEqual(len(v_n_r_dict[vrf]), 1)
        self.assertEqual(len(v_n_r_dict[vrf][network_name]), 2)
    ...
    def test_process_router_2_rids_2_vrfs_1_network(self):
        ...
        network_name = h_info1['network_name']
        self.assertEqual(len(v_n_r_dict), 1)
        self.assertEqual(len(v_n_r_dict[vrf1]), 1)
        self.assertEqual(len(v_n_r_dict[vrf1][network_name]), 1)
        ...
        driver.enable_internal_network_NAT.assert_called_with(
            ri2, ports[0], ex_gw_port2)
        network_name = h_info1['network_name']
        self.assertEqual(len(v_n_r_dict), 2)
        self.assertEqual(len(v_n_r_dict[vrf1]), 1)
        self.assertEqual(len(v_n_r_dict[vrf2]), 1)
        self.assertEqual(len(v_n_r_dict[vrf1][network_name]), 1)
        self.assertEqual(len(v_n_r_dict[vrf2][network_name]), 1)
    ...
    def test_process_router_2_rids_1_vrf_2_networks(self):
        ...
        self.assertEqual(len(v_n_r_dict), 1)
        self.assertEqual(len(v_n_r_dict[vrf]), 1)
        self.assertEqual(len(v_n_r_dict[vrf][network_name1]), 1)
        ...
        driver.enable_internal_network_NAT.assert_called_with(
            ri2, ports[0], ex_gw_port2)
        self.assertEqual(len(v_n_r_dict), 1)
        self.assertEqual(len(v_n_r_dict[vrf]), 2)
        self.assertEqual(len(v_n_r_dict[vrf][network_name1]), 1)
        self.assertEqual(len(v_n_r_dict[vrf][network_name2]), 1)
    ...
    def test_process_router_2_rids_2_vrfs_2_networks(self):
        ...
        self.assertEqual(len(v_n_r_dict), 1)
        self.assertEqual(len(v_n_r_dict[vrf1]), 1)
        self.assertEqual(len(v_n_r_dict[vrf1][network_name1]), 1)
        ...
        self.assertEqual(len(v_n_r_dict[vrf2]), 1)
        self.assertEqual(len(v_n_r_dict[vrf1][network_name1]), 1)
        self.assertEqual(len(v_n_r_dict[vrf2][network_name2]), 1)
