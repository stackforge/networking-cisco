...
class TestBacklogHostingDevice(base.BaseTestCase):
    ...
    def setUp(self):
        ...
        self.send_empty_cfg_mock = mock.MagicMock()
        drv_mock.return_value.send_empty_cfg = self.send_empty_cfg_mock
        self.drv_mgr.get_driver_for_hosting_device = drv_mock
    ...
    def test_check_backlog_empty(self):
        ...
        self.assertEqual(expected,
                         self.status.check_backlogged_hosting_devices(
                                                                 self.drv_mgr))
        self.assertEqual(0, self.send_empty_cfg_mock.call_count)
    ...
    def test_check_backlog_above_BT_revived_hosting_device(self):
        ...
        self.assertEqual(expected,
                    self.status.check_backlogged_hosting_devices(self.drv_mgr))
        self.assertEqual(1, self.send_empty_cfg_mock.call_count)
