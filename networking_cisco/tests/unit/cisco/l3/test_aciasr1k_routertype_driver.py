...
class AciAsr1kRouterTypeDriverNeutronTestCase(
    ...
    def test_get_apic_driver(self):
        ...
        with self.router(tenant_id=tenant_id) as router1:
            ...
            if self.l3_plugin._router_drivers.get(router_type_id):
                mock_driver = mock.Mock()
                mock_driver.apic_driver = self.dummy_gbp_l3
                self.l3_plugin._router_drivers[router_type_id] = mock_driver
