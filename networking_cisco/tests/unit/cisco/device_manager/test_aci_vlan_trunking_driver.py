...
class TestAciVLANTrunkingPlugDriverBase(
    ...
    def test_no_driver(self):
        ...
        self.assertIsNone(self.plugging_driver.apic_driver)
        self.assertFalse(self.plugging_driver.allocate_hosting_port(None,
            None, None, None, None))
...
class TestAciVLANTrunkingPlugDriverNeutron(TestAciVLANTrunkingPlugDriverGbp):
    ...
    def test_no_external_net_name(self):
        self.plugging_driver._apic_driver = None
        self.l3_plugin._core_plugin.mechanism_manager.mech_drivers = {}
        self.assertIsNone(self.plugging_driver.get_ext_net_name)
