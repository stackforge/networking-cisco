...
class TestCiscoUcsmMechDriver(testlib_api.SqlTestCase,
    ...
    def test_port_profile_delete_on_ucsm(self):
        ...
        # 1st call to delete_port_profile is designed to raise exception
        ...
        self.assertTrue(self.ucsm_driver.ucsm_db.get_port_profile_to_delete(
            PORT_PROFILE_1, UCSM_IP_ADDRESS_1))

        # 2nd call to _delete_port_profile is designed to return Port profile
        self.ucsm_driver._delete_port_profile(
            handle, PORT_PROFILE_1, UCSM_IP_ADDRESS_1)

        # Successful delete of PP on UCSM should remove entry that was added
        # to PP delete table
        self.assertFalse(self.ucsm_driver.ucsm_db.get_port_profile_to_delete(
            PORT_PROFILE_1, UCSM_IP_ADDRESS_1))
