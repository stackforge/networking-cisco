...
class TestCiscoUcsmMechDriver(testlib_api.SqlTestCase,
    ...
    def test_add_sp_template_config_to_db(self):
        ...
        self.assertEqual(sp_template_info[1],
                         ucsm.sp_template_list[HOST1].template)
    ...
    def test_parsing_of_single_ucsm_sp_template_config(self):
        ...
        cfg.CONF.set_override(
            "sp_template_list",
            {"Host11": conf.SPTemplate("SP_Template1_path", "SP_Template1"),
             "Host12": conf.SPTemplate("SP_Template1_path", "SP_Template1"),
             "Host21": conf.SPTemplate("SP_Template2_path", "SP_Template2"),
             "Host22": conf.SPTemplate("SP_Template2_path", "SP_Template2")},
            group="ml2_cisco_ucsm")
        ...
        sp_template = ucsm.sp_template_list["Host12"].template
