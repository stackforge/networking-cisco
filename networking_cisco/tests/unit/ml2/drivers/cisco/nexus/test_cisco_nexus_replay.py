...
class TestCiscoNexusNonCachedSshReplay(
    ...
    def setUp(self):
        ...
        cfg.CONF.set_override('never_cache_ssh_connection', True, 'ml2_cisco')
    ...
    def test_basic_replay_NonCacheSsh(self):
        ...
        self.assertEqual(self.mock_ncclient.connect.call_count, 20)
        self.assertEqual(
            self.mock_ncclient.connect.return_value.
            close_session.call_count, 20)
