...
class _TestModelsMigrationsCisco(test_migrations._TestModelsMigrations):
    ...
    def include_object(self, object_, name, type_, reflected, compare_to):
        # If table with alembic head version is named differently from
        # "alembic" then "name == 'alembic_repo'" should be added here
        # for expunction.
        if type_ == 'table' and (name == 'alembic' or
                                 name == 'alembic_repo' or
...
# class TestModelsMigrationsPsql(_TestModelsMigrationsCisco,
