...
class CiscoNexusRestapiClient(object):
    ...
    def _get_cookie(self, mgmt_ip, config):
        ...
        try:
            ...
            raise cexc.NexusConfigFailed(nexus_host=mgmt_ip,
                                         config=config,
                                         exc=e)
    ...
    def send_request(self, method, action, body=None,
                    headers=None, ipaddr=None, get_cookie=True):
    ...
    def rest_put(self, action, ipaddr=None, body=None, headers=None):
        return self.send_request("PUT", action, body=body,
                               headers=headers, ipaddr=ipaddr)
