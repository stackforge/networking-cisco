    ...
    def create_port_postcommit(self, context):
        ...
        if self._is_supported_deviceowner(port):
            ...
            if len(all_switches) == 1:
                # Verify you can talk to this switch;
                # otherwise, let exception bubble up so
                # other dbs cleaned and no further retries.
                self.driver.get_nexus_type(all_switches[0])
