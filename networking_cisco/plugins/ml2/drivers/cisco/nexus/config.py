...
nexus_sub_opts = [
    ...
    cfg.StrOpt('password',
        help=_('The password of the Nexus Switch Administrator is required '
               ...
               'for baremetal and VM deployments.')),
    cfg.StrOpt('physnet',
    ...
    base.RemainderOpt('compute_hosts',
        help=_('Multiple compute hosts can be configured for each switch. '
               '"compute_hosts" is not a keyword to assign values but a '
               'placeholder to configure these compute hosts. For each host '
               ...
               'other than a new line. This configuration applies to'
               'non-baremetal deployments only.'
               ))]
