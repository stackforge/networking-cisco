...
class NexusVPCExpectedChgrp(exceptions.NeutronException):
    """No port channel id with a list of baremetal interfaces."""
    message = _("Failed to get port channel id.  First interface %(first)s")
