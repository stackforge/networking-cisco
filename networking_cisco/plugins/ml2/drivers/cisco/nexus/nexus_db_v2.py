...
def _get_all_switch_vpcid_join(switch_ip_list):
    '''Get list of common vpcids in list of switches.'''
...
def get_free_switch_vpcids(switch_ip):
    return(_lookup_all_vpcids(switch_ip=switch_ip, active=False))
...
def alloc_vpcid(nexus_ips):
    ...
    vpc_id = 0
    intersect = _get_all_switch_vpcid_join(nexus_ips)
