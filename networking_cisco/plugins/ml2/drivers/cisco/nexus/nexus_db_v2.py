...
def _get_vpcid_switch_intersect(nexus_ips):
    ...
    # Shuffle list to produce an unpredictable list order.
    # This reduces the likelihood of delivering same vpc_id
    # at same time to different requestors.
...
def alloc_vpcid(nexus_ips):
    ...
    vpc_id = 0
    intersect = _get_vpcid_switch_intersect(nexus_ips)
