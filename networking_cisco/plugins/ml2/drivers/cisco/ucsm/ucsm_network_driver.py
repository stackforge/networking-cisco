                ...
                try:
                    ...
                    if not obj:
                        LOG.error(_LE('UCS Manager network driver could not '
                            'find Service Profile template %s at'),
                    ...
                    return self._handle_ucsm_exception(
                        e,
                        'Service Profile Template', sp_template, ucsm_ip)
