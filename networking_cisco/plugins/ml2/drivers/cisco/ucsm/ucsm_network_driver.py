...
class CiscoUcsmDriver(object):
    ...
    def _disable_ssl_cert_check(self):
        """From Python version 2.7.9, SSL class performs certificate and
           hostname checks by default. UcsSdk is currently not able to
           handle these certificate checks. This method disables this behavior.
           Once support for SSL certificates is added to ucssdk, we can remove
           this method.
           """
