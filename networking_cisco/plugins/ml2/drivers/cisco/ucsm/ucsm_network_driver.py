...
class CiscoUcsmDriver(object):
    ...
    def _update_sp_template_config(self, host_id, ucsm_ip,
                            ...
                            if sp.PnDn != "":
                                ...
                                if server_name == host_id:
                                    ...
                                    LOG.debug('Server SP Template %s',
                                        sp.OperSrcTemplName)
                                    self._update_sp_template_config(
