...
class CiscoUcsmDriver(object):
    ...
    def _create_host_and_sp_dicts_from_config(self):
        ...
        # If no hosts/sps in the config, then learn the hosts and sps from the
        # UCSMs
        if not (self.ucsm_sp_dict and self.ucsm_host_dict):
    ...
    def ucs_manager_connect(self, ucsm_ip):
        ...
        if not ucsm or not ucsm.username or not ucsm.password:
        ...
        try:
            handle.Login(ucsm_ip, ucsm.username, ucsm.password)
    ...
    def _remove_vlan_from_all_sp_templates(self, handle, vlan_id, ucsm_ip):
        ...
        try:
            ...
            for sp_template_info in sp_template_info_list:
                ...
                sp_template = sp_template_info.template
