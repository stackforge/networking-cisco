...
ml2_cisco_ucsm_opts = [
    cfg.StrOpt('ucsm_ip',
               help=_('Cisco UCS Manager IP address. This is a required field '
                      'to communicate with a Cisco UCS Manager. For example: '
                      'ucsm_ip = 192.168.1.100')),
...
ml2_cisco_ucsm_common = [
    ...
    cfg.ListOpt('ucsm_virtio_eth_ports',
                ...
                help=_('Ethernet port names to be used for virtio ports. '
                       ...
                       'names on the UCS Manager. For example: '
    ...
    cfg.DictOpt('ucsm_host_list',
                help=_('Hostname to Service profile mapping for UCS Manager '
                       ...
                       'ucsm_host_list = Hostname1:Serviceprofile1, '
    ...
    cfg.StrOpt('sriov_qos_policy',
               help=_('Pre-defined QoS policy name. This config allows the '
                      ...
                      'SR-IOV ports. For example: '
                      'sriov_qos_policy = qos_policy1')),
