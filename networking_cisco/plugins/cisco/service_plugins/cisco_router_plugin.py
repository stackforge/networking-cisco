...
from networking_cisco.plugins.cisco.l3.rpc import (l3_router_cfgagent_rpc_cb as
                                          l3_router_rpc)
from networking_cisco.plugins.cisco.l3.rpc import devices_cfgagent_rpc_cb as devices_rpc
