...
class N1kvML2TrunkingPlugDriver(plug.PluginSidePluggingDriver,
                ...
                for i in range(max_hosted):
                    ...
                    p_spec['port'].update(
                        {'name': n1kv_const.T1_PORT_NAME + index,
                         ...
                         'fixed_ips': cons.ATTR_NOT_SPECIFIED,
                         'mac_address': cons.ATTR_NOT_SPECIFIED,
    ...
    def _get_create_t_network_id(self, context, tenant_id, type_name,
            ...
            s_spec = {'subnet': {
                ...
                'cidr': subnet_cidr,
                'enable_dhcp': False,
                'gateway_ip': cons.ATTR_NOT_SPECIFIED,
                'allocation_pools': cons.ATTR_NOT_SPECIFIED,
                'ip_version': 4,
                'dns_nameservers': cons.ATTR_NOT_SPECIFIED,
                'host_routes': cons.ATTR_NOT_SPECIFIED}}
