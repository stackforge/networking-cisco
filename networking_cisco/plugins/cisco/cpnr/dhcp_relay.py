...
from networking_cisco._i18n import _LE, _LW, _LI
...
OPTS = [
    cfg.StrOpt('http_server',
               ...
               help=_LI('External HTTP server, should conform to '
                      '<server_name:port> format.')),
    cfg.StrOpt('admin_email',
               default='test@example.com',
               help=_LI('Email address of admin for internal DNS domain.')),
    cfg.StrOpt('external_interface',
               default='lo',
               help=_LI('Interface for communicating with DHCP/DNS server')),
    cfg.StrOpt('dhcp_server_addr',
               default='127.0.0.1',
               help=_LI('DHCP server IP address')),
    cfg.IntOpt('dhcp_server_port',
               default=67,
               help=_LI('DHCP server UDP port number')),
    cfg.BoolOpt('enable_dhcp_stats',
                default=False,
                help=_LI('Enable DHCP stats')),
    cfg.IntOpt('dhcp_stats_interval',
               default=60,
               help=_LI('DHCP stats polling interval'))
]
